  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) { // Got an error!
      ...
      L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
        mapboxToken: 'pk.eyJ1IjoiYWthZGltIiwiYSI6ImNqczFkeXFjeDFuNjQ0NG9hcnlvanB1cm4ifQ.V2LnuS9_ddwxHOx6tpTuHQ',
        maxZoom: 18,
...
createReviewHTML = (review) => {
  ...
  li.appendChild(review_header);

  const review_body = document.createElement('div');
  review_body.classList.add('review_body');
